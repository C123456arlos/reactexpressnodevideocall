...
const LoginPage = () => {
    ...
    return (
        <div className="h-screen items-center justify-center p-4 sm:p-6 md:p-8 flex" data-theme='forest'>
                                ...
                                <div className="flex flex-col gap-3">
                                    <div className="form-control w-full space-y-2">
                                        ...
                                        <input type="email" placeholder='test@test.com'
                                            className="input input-bordered w-full" value={loginData.email}
                                    ...
                                    <div className="text-center mt-4">
                                        <p className="text-sm">no account {'  '}
                ...
                <div className="hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center">
                    <div className="max-w-md p-8">
                        <div className="relative aspect-square max-w-sm mx-auto">
                            <img src="/1.png" alt="language connection" className="w-full h-full"></img>
                        </div>
                        <div className="text-center space-y-3 mt-6">
                            <h2 className="text-xl font-semibold">connect with language</h2>
                            <p className="opacity-70">practice conversations</p>
                        </div>
                    </div>
                </div>
            </div>
