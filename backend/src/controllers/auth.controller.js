...
//         if (existingUser) {
//             return res.status(400).json({ message: 'user exists use different email' })
//         }
...
//             })
//             console.log(`stream user after onboarding ${updatedUser.fullName}`)
//         } catch (streamError) {
//             console.log('error updating stream', streamError.message)
//         }
